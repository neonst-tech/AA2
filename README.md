# AA2 — Company Asset Tracking Portal

Starter repository for the **Company Asset Tracking Portal** project.
...
```bash
git clone https://github.com/neonst-tech/AA2.git
cd AA2
```
...
```text
AA2/
├── asset_tracking/     # Main Django application
...
- Data models, views, URLs, templates, validation, management functionality, and business rules are intentionally left for implementation from the project requirements.
